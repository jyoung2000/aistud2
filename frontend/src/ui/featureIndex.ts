...
export const FEATURE_INDEX: FeatureEntry[] = [
  ...
  { key: "layer-via-copy", name: "Selection → new layer", keywords: ["copy", "duplicate", "extract", "selection", "new layer", "move to layer"], tourTarget: "layers", blurb: "Moves the selected area onto its own movable layer — the 'sel → layer' button atop the Layers panel, or ⌘J.", shortcut: "⌘J", group: "Layers" },
  { key: "merge-layers", name: "Merge layers", keywords: ["merge", "combine", "flatten two", "join"], tourTarget: "layers", blurb: "Select 2+ layers (Ctrl-click), then Merge combines them into one layer with transforms baked in.", group: "Layers" },
  { key: "edit-layer-ai", name: "Edit a whole layer with AI", keywords: ["layer", "edit", "ai", "whole", "entire"], tourTarget: "layers", blurb: "The ⬚ AI button on any layer row selects that layer's exact pixels — describe the change and Generate edits the whole layer at once.", group: "Layers" },
